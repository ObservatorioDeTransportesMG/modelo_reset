...
def baixar_malha_municipal(diretorio_saida: str, uf: str = "MG", ano: int = 2022) -> Optional[str]:
	...
	"""
	url = f"https://geoftp.ibge.gov.br/organizacao_do_territorio/malhas_territoriais/malhas_de_setores_censitarios__divisoes_intramunicipais/censo_{ano}/setores/shp/UF/{uf}_setores_CD2{ano}.zip"
